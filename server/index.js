...
const webhookList = [
  { topic: 'orders/create', event: 'order-create' },
  { topic: 'carts/update', event: 'carts-update' }
];
...
const shopifyConfig = {
  ...
  afterAuth(request, response) {
    ...
    webhookList.forEach(webhookElement => {
      registerWebhook(shop, accessToken, {
        topic: webhookElement.topic,
        address: `${SHOPIFY_APP_NGROK_HOST}/webhook/${webhookElement.event}`,
        format: 'json'
      });
    });
